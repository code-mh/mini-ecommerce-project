...
export default function Cart({cartItems , setCartItems}) {
   ...
   function decreaseQty(item){
    ...
    return  cartItems.length> 0 ?<Fragment>
                        ...
                        <div className="w-[92%] md:w-[86%] lg:w-[78%] max-w-screen-xl mt-10">
                            ...
                            <aside className="w-full lg:w-1/3 flex justify-center lg:justify-end lg:ml-30" >
                                ...
                                <div className="flex justify-between py-2">
                                    ...
                                    <span className="font-semibold">{cartItems.reduce((acc,item)=>{ return acc+ item.qty},0)} (Units)</span>
                                </div>
                                ...
                                <div className="flex justify-between py-2">
                                    ...
                                    <span className="font-semibold">{new Intl.NumberFormat("en-IN", {
                                                                        ...
                                                                        cartItems.reduce((acc, item) => {
                                                                            return acc + (item.product.price * 89.96) * item.qty;
                                                                        }, 0)
                                                                    )}
                                    </span>
                                </div>
            ...
            </Fragment> :( !complete ? <h2 className="text-3xl font-semibold text-center mt-10">Your Cart is Empty</h2> : 
                            <Fragment>
                                <h2 className="text-3xl font-semibold text-center mt-10">Order Completed!</h2>
